...
var ValidationExecutor = /** @class */ (function () {
    ...
    ValidationExecutor.prototype.execute = function (object, targetSchema, validationErrors) {
        ...
        var groups = this.validatorOptions
        ...
        var PREDEFINED_VALIDATION_TYPES = [
            ValidationTypes_1.ValidationTypes.NESTED_VALIDATION,
            ValidationTypes_1.ValidationTypes.CONDITIONAL_VALIDATION,
            ValidationTypes_1.ValidationTypes.WHITELIST,
            ValidationTypes_1.ValidationTypes.IS_DEFINED
        ];
        // General validation
        Object.keys(groupedMetadatas).forEach(function (propertyName) {
            ...
            var metadatas = groupedMetadatas[propertyName].filter(function (metadata) {
                return metadata.type !== ValidationTypes_1.ValidationTypes.IS_DEFINED &&
                    metadata.type !== ValidationTypes_1.ValidationTypes.WHITELIST;
            });
            var customValidationMetadatas = metadatas.filter(function (metadata) {
                return PREDEFINED_VALIDATION_TYPES.indexOf(metadata.type) === -1;
            });
            ...
            _this.runValidations(object, value, definedMetadatas, validationError.constraints);
            if ((value === null || value === undefined) &&
                _this.validatorOptions &&
                _this.validatorOptions.skipMissingProperties === true) {
                return;
            }
            _this.runValidations(object, value, customValidationMetadatas, validationError.constraints);
            ...
            if (this.validatorOptions &&
                ...
                notAllowedProperties.forEach(function (property) {
                    ...
                    validationErrors.push({
                        ...
                        children: undefined,
                        constraints: (_a = {},
                            _a[ValidationTypes_1.ValidationTypes.WHITELIST] = "property " + property + " should not exist",
                            _a)
                    });
                });
            }
    ...
    ValidationExecutor.prototype.runValidations = function (object, value, metadatas, errorMap) {
        var _this = this;
        metadatas.forEach(function (metadata) {
            container_1.getFromContainer(MetadataStorage_1.MetadataStorage)
                .getTargetValidatorConstraints(metadata.constraintCls)
                .forEach(function (customConstraintMetadata) {
                if (customConstraintMetadata.async &&
                    _this.ignoreAsyncValidations) {
                    return;
                }
                var validateValues = metadata.each && value instanceof Array
                    ? [].concat(value)
                    : [value];
                validateValues.forEach(function (value) {
    ...
    ValidationExecutor.prototype.nestedValidations = function (value, metadatas, errors) {
        ...
        metadatas.forEach(function (metadata) {
            ...
            var targetSchema = typeof metadata.target === "string"
                ? metadata.target
                : undefined;
    ...
    ValidationExecutor.prototype.createValidationError = function (object, value, metadata, customValidatorMetadata) {
        var targetName = object.constructor
            ? object.constructor.name
            : undefined;
    ...
    ValidationExecutor.prototype.getConstraintType = function (metadata, customValidatorMetadata) {
        var type = customValidatorMetadata && customValidatorMetadata.name
